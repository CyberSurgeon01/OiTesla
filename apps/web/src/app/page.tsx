...
export default function Home() {
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-x-hidden bg-[#05050A] text-white px-6 py-24 selection:bg-[#4F6BFF]/30">
      ...
      <div className="absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#4F6BFF] opacity-15 blur-[120px] pointer-events-none animate-[pulse_6s_ease-in-out_infinite] sm:h-[700px] sm:w-[700px] sm:opacity-10" />
      {/* Subtle Rickshaw Amber Glow */}
      <div className="absolute top-[60%] left-[60%] h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#F59E0B] opacity-5 blur-[100px] pointer-events-none sm:h-[400px] sm:w-[400px]" />
