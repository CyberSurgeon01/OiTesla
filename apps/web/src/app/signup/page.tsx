...
export default function Signup() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-x-hidden bg-[#05050A] text-white px-6 py-12 selection:bg-[#4F6BFF]/30">
      ...
      <div className="absolute top-1/3 right-1/4 h-[400px] w-[400px] -translate-y-1/2 rounded-full bg-[#4F6BFF] opacity-10 blur-[120px] pointer-events-none animate-[pulse_6s_ease-in-out_infinite]" />
      <div className="absolute bottom-1/4 left-1/4 h-[300px] w-[300px] rounded-full bg-[#F59E0B] opacity-5 blur-[100px] pointer-events-none" />
